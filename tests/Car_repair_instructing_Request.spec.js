...
const { CarRepairInstructingRequest } = require("../test_data/requestdata");
...
test("Car repair instructing Request", async ({page, browser}) => {
    ...
    await contactpage.selectContact(CarRepairInstructingRequest.contactName);

    // PBO/BO Creating Service Request
    await createservicerequest.createServiceRequest(CarRepairInstructingRequest.requestname,
        CarRepairInstructingRequest.requestfullname,
        CarRepairInstructingRequest.accountNumber,
        CarRepairInstructingRequest.problemDescription);
    await createservicerequest.selectAccidented("No");
    await createservicerequest.clickSaveandClose();
    const srNum = await createservicerequest.OpenSR(CarRepairInstructingRequest.tableSRXpath);
